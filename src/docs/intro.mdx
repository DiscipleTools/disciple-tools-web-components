...
<script src="https://cdn.jsdelivr.net/npm/@disciple.tools/web-components@0.7.0/index.js"></script>
```
...
wp_enqueue_script( 'dt-web-components-js', "https://cdn.jsdelivr.net/npm/@disciple.tools/web-components@$dtwc_version/index.js", $dtwc_version );
