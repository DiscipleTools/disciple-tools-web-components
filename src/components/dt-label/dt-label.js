...
export class DtLabel extends LitElement {
  static get styles() {
    return css`
      :host {
  ...
  render() {
    return html`
      <div
        class="label"
      >
        <span class="icon"><slot name="icon-start"></slot></span>
        <slot></slot>
        
        ${this.private ? html`<span class="icon private">
          ...
          <span class="tooltip"><slot name="private-tooltip">Private Field: Only I can see its content</slot></span>
        </span>
        ` : null}
      </div>
    `;
