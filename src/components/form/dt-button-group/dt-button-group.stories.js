...
export default {
  title: 'Form/dt-button-group',
  component: 'dt-button-group',
  argTypes: {
    theme: {
      control: 'select',
    ...
    loading: {
      ...
      table: {
        type: {
          summary: 'loading',
          detail: '<dt-button-group loading />',
        },
      },
    },
    saved: {
    ...
    onchange: {
      ...
      table: {
        type: {
          ...
          detail: '<dt-button-group onchange="onChange(event)" />',
        },
      },
    },
    locale: {
