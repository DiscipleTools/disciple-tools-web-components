...
function Template({ id = 'name', name = 'field-name', label = 'Field Name' , value = '', min = '', max = '', disabled = false, icon='https://cdn-icons-png.flaticon.com/512/1077/1077114.png', isPrivate = false, loading = false, saved = false, onchange = 'onChange' }) {
  return html`
    <dt-number
      id=${id}
      name=${name}
