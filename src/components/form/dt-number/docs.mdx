...
| `--dt-form-invalid-border-color` | `#dc3545`  |
| `--dt-number-box-shadow` | Fallback to `--dt-form-input-box-shadow` |
| `--dt-number-disabled-background-color` | Fallback to `--dt-form-disabled-background-color` |
