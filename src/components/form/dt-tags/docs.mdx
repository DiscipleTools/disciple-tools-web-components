...
| :----------------------------------------- | :-------------------------------------------- | :--------------------------------------------------- |
| `--dt-tags-selected-link-color`            | Color of the links in selected tags           | `var(--dt-color-primary, #3f729b)`                   |
...
| `--dt-tags-add-button-hover-background-color` | Background color of the add button on hover | `var(--dt-color-success, #cc4b37)`                   |
