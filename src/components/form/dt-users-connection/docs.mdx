...
import * as ComponentStories from './dt-users-connection.stories.js';
...
| :------------------------------ | :------------------------------- | :-------------------------------- |
| `--dt-users-connection-icon-fill` | Fill color for the user icon SVG | `var(--primary-color)`         |
...
- [DtTags](?path=/docs/components-form-tags--docs#parts)
