...
describe('dt-dropdown', () => {
  it('sets placeholder', async () => {
    const el = await fixture(
      html`<dt-dropdown placeholder="Custom Placeholder"></dt-dropdown>`
    );
    const input = el.shadowRoot.querySelector('input');
  ...
  it('sets options', async () => {
    const el = await fixture(
      html`<dt-dropdown options="${JSON.stringify(options)}"></dt-dropdown>`
    );
  ...
  it('allows adding new option', async () => {
    const el = await fixture(
      html`<dt-dropdown options="${JSON.stringify(options)}" allowAdd></dt-dropdown>`
    );
