...
const defaultPostTypeSettings = {
  ...
  "groups": {
      ...
      "tile": "other",
      "icon": "https://rsdt.local/wp-content/themes/disciple-tools-theme/dt-assets/images/group-type.svg?v=2",
      "create-icon": "https://rsdt.local/wp-content/themes/disciple-tools-theme/dt-assets/images/add-group.svg?v=2",
      "show_in_table": 35,
...
const arabicDefaultPostTypeSettings = {
  ...
  "overall_status": {
      ...
      "default": {
          ...
          "unassignable": {
              "label": "ليس جاهز",
              "description": "لا يوجد معلومات كافية تسمح للمضي قدما مع جهة الاتصال في هذا الوقت.",
              "color": "#FF9800"
          },
          "unassigned": {
          ...
          "closed": {
              ...
              "color": "#808080",
              "description": "لا تريد جهة الاتصال هذه إكمال التواصل أو أنت بنفسك قررت إيقاف متابعته"
          }
      },
      "default_color": "#366184",
      "tile": "status",
  ...
  "milestones": {
      "name": "مراحل الإيمان",
      "description": "حدد المراحل التي وصل إليها الاتصال في رحلة الإيمان. هذه نقاط في الرحلة الروحية لجهة اتصال تستحق الاحتفال ولكن يمكن أن تحدث بأي ترتيب.",
      "type": "multi_select",
      "default": {
          "milestone_has_bible": {
              "label": "يملك الانجيل",
  ...
  "subassigned": {
      ...
      "description": "جهة اتصال أو مستخدم يساعد المستخدم المعين على المتابعة مع جهة الاتصال.",
      "type": "connection",
      "post_type": "contacts",
      "p2p_direction": "to",
      "p2p_key": "contacts_to_subassigned",
  ...
  "seeker_path": {
      "name": "مسار الباحث",
      "description": "تعيين حالة تقدمك مع جهة الاتصال. هذه هي الخطوات التي تحدث في ترتيب معين لمساعدة جهة اتصال على المضي قدمًا.",
      "type": "key_select",
      "default": {
          "none": {
  ...
  "reason_paused": {
      "name": "سبب الإيقاف",
      "description": "جهة الاتصال المتوقفة مؤقتًا هي تلك التي لا تتفاعل معها حاليًا ولكن تتوقعها في المستقبل.",
      "type": "key_select",
      "default": {
          "none": {
              "label": ""
          ...
          "wait_and_see": {
              "label": "نريد أن نرى ما إذا كانت جهة الاتصال تستجيب للرسائل النصية الآلية"
          }
      },
      "customizable": "all",
      "only_for_types": [
  ...
  "reason_closed": {
      "name": "Reason Archived",
      "description": "جهة الاتصال المغلقة هي جهة لا يمكنك أو لا ترغب في التفاعل معها.",
      "type": "key_select",
      "default": {
          "none": {
              "label": ""
  ...
  "sources": {
      "name": "المصادر",
      "description": "الموقع الإلكتروني أو الحدث أو الموقع الذي أتت منه جهة الاتصال هذه.",
      "type": "multi_select",
      "default": {
          "personal": {
              "label": "خاص",
  ...
  "campaigns": {
      "name": "الحملات",
      "description": "حملات التسويق أو أنشطة الوصول التي تفاعلت معها جهة الاتصال هذه.",
      "tile": "details",
      "type": "tags",
      "default": [],
      "icon": "https://rsdt.local/wp-content/themes/disciple-tools-theme/dt-assets/images/megaphone.svg?v=2",
